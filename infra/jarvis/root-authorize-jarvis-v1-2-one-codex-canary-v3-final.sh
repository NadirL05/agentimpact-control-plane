#!/usr/bin/env bash
# Root one-shot authorization for Jarvis V1.2 Codex canary V3-FINAL.
#
...
# Previous consumed authorizations cannot be reused — Nadir must mint a NEW file.
set -euo pipefail

CANONICAL_CANARY=/opt/agentimpact/runner/superset-rpc-bridge/scripts/root-run-jarvis-v1-2-codex-canary-v3-final.sh
EXPECTED_CANARY_SHA256=bd6db2c8a57c21b22203ec74bd9f1ef98bd910fefc7837b55e3dbe49f4879ed6
TTL_SECONDS=900
...
echo "NOTE=previous_consumed_authorization_requires_new_file"
