#!/usr/bin/env bash
# Root one-shot authorization for Jarvis V1.2 Codex canary V3-FINAL (convergence).
set -euo pipefail
CANONICAL_CANARY=/opt/agentimpact/runner/superset-rpc-bridge/scripts/root-run-jarvis-v1-2-codex-canary-v3-final.sh
EXPECTED_CANARY_SHA256=6848325a90b047fae2f064a7aa2fa959a43cad824053b44fcac07578344533de
TTL_SECONDS=900
