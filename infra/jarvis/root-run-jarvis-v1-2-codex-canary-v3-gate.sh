#!/usr/bin/env bash
# Jarvis V1.2 ONE-SHOT Codex canary V3-GATE — post multi-gate runtime.
...
REPORT="${REPORT_DIR}/jarvis-v1-2-codex-canary-v3-gate-${STAMP}.txt"
ROLLBACK_DIR="/var/lib/agentimpact/rollback/jarvis-v1-2-canary-v3-gate-${STAMP}"
FIXTURE_SRC="${REPO}/infra/jarvis/canary-fixtures/increment"
FIXTURE_HOST="/var/lib/agentimpact-superset/fixtures/jarvis-v1-2-codex-canary-v3-gate-${STAMP}"
API_BASE="${API_BASE:-http://127.0.0.1:3000}"
ORG_ID="org-jarvis-v12-canary-v3g"
...
BRIDGE_DROPIN="${BRIDGE_DROPIN_DIR}/99-jarvis-canary-v3-gate-temp.conf"
...
log "=== JARVIS V1.2 CODEX CANARY V3-GATE ==="
log "CANARY_V3_IMPLEMENTATION=MULTI_GATE_RUNTIME"
...
mkdir -p "${APP_SRC}/core/missions-v2/jarvis" "${APP_SRC}/core/missions-v2/superset" "${APP_SRC}/api"
...
chown -R hermes:hermes "${APP_SRC}/core/missions-v2/jarvis" "${APP_SRC}/core/missions-v2/superset"
