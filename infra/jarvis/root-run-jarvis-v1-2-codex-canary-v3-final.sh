...
REPORT="${REPORT_DIR}/jarvis-v1-2-codex-canary-v3-final-${STAMP}.txt"
ROLLBACK_DIR="/var/lib/agentimpact/rollback/jarvis-v1-2-canary-v3-final-${STAMP}"
FIXTURE_SRC="${REPO}/infra/jarvis/canary-fixtures/increment"
FIXTURE_HOST="/var/lib/agentimpact-superset/fixtures/jarvis-v1-2-codex-canary-v3-final-${STAMP}"
API_BASE="${API_BASE:-http://127.0.0.1:3000}"
ORG_ID="org-jarvis-v12-canary-v3f"
...
BRIDGE_DROPIN="${BRIDGE_DROPIN_DIR}/99-jarvis-canary-v3-final-temp.conf"
