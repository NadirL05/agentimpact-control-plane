#!/usr/bin/env bash
# Root one-shot authorization for Jarvis V1.2 Codex canary V3-QUOTA.
# Pins canary SHA; outer-verify may pass unused tarball as $1.
# Does NOT execute Codex. Static probe: AGENTIMPACT_AUTH_HELPER_STATIC_PROBE=1
set -euo pipefail
CANONICAL_CANARY=/opt/agentimpact/runner/superset-rpc-bridge/scripts/root-run-jarvis-v1-2-codex-canary-v3-quota.sh
EXPECTED_CANARY_SHA256=b0d9cf6c69e19ec0ed460281b906a1bc760255419d774bec11bde671baee1912
TTL_SECONDS=900
